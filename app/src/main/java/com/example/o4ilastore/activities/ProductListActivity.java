...
public class ProductListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Настройка на RecyclerView с GridLayout
        ...
        // Логване на SharedPreferences за отстраняване на грешки
        Log.d("isAdmin", "User is admin: " + isAdmin);
        Map<String, ?> allPrefs = prefs.getAll();
        for (Map.Entry<String, ?> entry : allPrefs.entrySet()) {
            Log.d("PrefsDebug", entry.getKey() + ": " + entry.getValue().toString());
        }

        // Показване или скриване на бутона за добавяне на продукт
    ...
    protected void onResume() {
        super.onResume();
        loadProducts(); // Презареди списъка след връщане от AddProductActivity
    }
