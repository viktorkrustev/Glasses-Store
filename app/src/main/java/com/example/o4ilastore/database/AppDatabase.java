                                    ...
                                    Executors.newSingleThreadExecutor().execute(() -> {
                                        ...
                                        if (database != null) {
                                            try {
                                                ...
                                                glassesDao.insert(new Glasses(10, "Classic glasses", 129.99, 1, 3, "glasses11.png", "Кръгли", 5, "Класически модел с метална рамка и универсален стил."));
                                                ...
                                                glassesDao.insert(new Glasses(9, "Night Owl", 109.00, 1, 3, "glasses10.png", "Квадратни", 18, "Подходящи за нощно виждане и ниска осветеност."));
