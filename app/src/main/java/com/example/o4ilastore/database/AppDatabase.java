                                    ...
                                    Executors.newSingleThreadExecutor().execute(() -> {
                                        ...
                                        if (database != null) {
                                            try {
                                                ...
                                                glassesDao.insert(new Glasses(10, "Classic glasses", 129.99, 1, 3, "https://drive.google.com/file/d/1GrOb5x6_dODLHFXzARd8b8Hk6F6xPXoy/view?usp=drive_link", "Кръгли", 5, "Класически модел с метална рамка и универсален стил."));
                                                ...
                                                glassesDao.insert(new Glasses(9, "Night Owl", 109.00, 1, 3, "https://drive.google.com/file/d/1sZDJTrUcjQVmBek4eMU7uWhcGMT8AB9A/view?usp=drive_link", "Квадратни", 18, "Подходящи за нощно виждане и ниска осветеност."));
